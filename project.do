...
vlog -sv -svinputport=var -work rtl_work dual_port0.v
...
vlog -sv -svinputport=var -work rtl_work +define+SIMULATION milestone_1.v
vlog -sv -svinputport=var -work rtl_work +define+SIMULATION milestone_2.v
vlog -sv -svinputport=var -work rtl_work +define+SIMULATION milestone_3.v
...
# mem save -o simulation_RAM0.mem -f mti -data decimal -addr hex -wordsperline 8 /tb_project_v2/uut/SRAM_unit/altsyncram_component/mem_data
